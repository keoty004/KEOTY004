...
class Workshop:
    ...
    """ Removes material from teh workshop """
...
Crafter is an abstract class which contains abstract methods:
    craft and disassemble which both get overwritten
    
"""
class Crafter(ABC):

    """ craft method to get overwritten """
    @abstractmethod
    def craft(self):
        pass

    """ disassemble method to get overwritten """
    @abstractmethod
...
Forge class which contains methods to deal with the weapons which include:
    crafters, disassemblers, setters and getters
...
class Forge(Crafter):
    ...
    """ Crafts the weapon from the materials provided and removes them from the materials disctionary"""
    ...
    """ Disassembles the weapon provided and stores materials in the materials dictionary"""
...
class Weapon:
    ...
    """ implementing properties for weapon functions """
